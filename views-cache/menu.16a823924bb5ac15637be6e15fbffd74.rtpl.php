    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <div class="imgcontainer">
            <h1 class="mt-4"><img src="\res\images\corujaLendo.jpg" alt="Avatar" class="avatar"> Home:</h1>
        </div>
        <p>All registered books can be found here.</p>
      </div>
      ...
      <div class="container-fluid">
        <table class="table table-striped">
          ...
          <tbody>
            ...
            <tr>
              <td><?php echo htmlspecialchars( $value1["idbook"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
              <td><?php echo htmlspecialchars( $value1["destitle"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
              <td><?php echo htmlspecialchars( $value1["desauthor"], ENT_COMPAT, 'UTF-8', FALSE ); ?></td>
              ...
              <td><?php if( $value1["status"] == 0 ){ ?>Available<?php }else{ ?>Borrowed<?php } ?></td>
              <td>
                  <a href="/menu/register-update/<?php echo htmlspecialchars( $value1["idbook"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i> Edit</a>
