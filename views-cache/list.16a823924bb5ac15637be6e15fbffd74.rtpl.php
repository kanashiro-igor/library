    ...
    <div id="page-content-wrapper">
      ...
      <div class="container-fluid">
        <div class="imgcontainer">
            <h1 class="mt-4"><img src="\res\images\corujaLendo.jpg" alt="Avatar" class="avatar"> List:</h1>
        </div>
        <p>All borrowed books can be found here.</p>
      </div>
      ...
      <div class="container-fluid">
        <table class="table table-striped">
          ...
          <tbody>
            <?php $counter1=-1;  if( isset($borrowed) && ( is_array($borrowed) || $borrowed instanceof Traversable ) && sizeof($borrowed) ) foreach( $borrowed as $key1 => $value1 ){ $counter1++; ?>
